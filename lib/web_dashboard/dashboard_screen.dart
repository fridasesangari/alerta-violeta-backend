  ...
  Future<void> loadReports() async {
    ...
    for (var report in data) {
      ...
      if (categoria == 'acoso') {
        ...
        seguimientoCount++;
      } else if (categoria.contains('violencia')) {
        violenciaCount++;
      }
    }
        ...
        children: [
          ...
          Row(
            children: [
              ...
              statCard("Transporte", seguimiento.toString(), Icons.directions_bus),
        ...
        BarChartData(
          barGroups: [
            ...
            BarChartGroupData(
              ...
              barRods: [
                BarChartRodData(toY: seguimiento.toDouble(), color: Colors.blue),
              ],
            ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      legendItem(Colors.blue, "Transporte"),

                      const SizedBox(height: 20),

                      legendItem(Colors.red, "Violencia"),
                    ],
                  ),
                ),
              ],
